...
public class SitSettingCommand implements CommandExecutor, TabCompleter {
    private final SitSettingsStorage settingsStorage;
    private final MessageService messages;

    public SitSettingCommand(SitSettingsStorage settingsStorage, MessageService messages) {
