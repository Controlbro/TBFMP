...
public class TpaCommand implements CommandExecutor {
    ...
    public TpaCommand(TpaManager tpaManager, MessageService messages) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 1) {
            messages.sendMessage(player, messages.getMessage("messages.tpa-usage"));
            return true;
        }
        ...
        tpaManager.requestTeleport(player, target, TpaManager.TpaRequestType.TO);
        return true;
    }
}
